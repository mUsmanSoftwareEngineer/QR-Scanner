...
import scanner.app.scan.qrcode.reader.adapter.SupportedAdapter;
import scanner.app.scan.qrcode.reader.data.constant.SupportedModelClass;


public class ScanSupported extends Fragment {
    ...
    private void initSupportedModelClassList() {
        ...
        supportedModelClassList.add(new SupportedModelClass("Aztec", R.drawable.wrong_2, R.drawable.aztec));
