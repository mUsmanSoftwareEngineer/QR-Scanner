package com.infinity.interactive.scanqr.generateqr.zxing.core;
...
public abstract class BarcodeScannerView extends FrameLayout implements Camera.PreviewCallback  {
    ...
    @ColorInt private int mLaserColor = ResourcesCompat.getColor(getResources(), R.color.viewfinder_laser,null);
    @ColorInt private int mBorderColor = ResourcesCompat.getColor(getResources(),R.color.viewfinder_border,null);
...
//    @ColorInt private int mBorderColor = getResources().getColor(R.color.viewfinder_border);
    private int mMaskColor = ResourcesCompat.getColor(getResources(), R.color.viewfinder_mask, null);
//    getResources().getColor(R.color.viewFinderColor);
    ...
    private float mAspectTolerance = 0.8f;
    ...
    public void setFlash(boolean flag) {
        ...
        if(mCameraWrapper != null && CameraUtils.isFlashSupported(mCameraWrapper.mCamera)) {
            ...
            try {
                parameters = mCameraWrapper.mCamera.getParameters();
    ...
    public void setZoom(float targetZoomRatio) {
        Camera.Parameters parameters = mCameraWrapper.mCamera.getParameters();
