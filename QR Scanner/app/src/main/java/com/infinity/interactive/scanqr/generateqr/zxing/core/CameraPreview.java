...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    float mAspectTolerance = 0.5f;
    protected boolean mSquareViewFinder;
    public  static int heightFinder;
...
//        int w = getWidth();
//        int h = getHeight();
//        if (me.dm7.barcodescanner.core.DisplayUtils.getScreenOrientation(getContext()) == Configuration.ORIENTATION_PORTRAIT) {
//            int portraitWidth = h;
//            h = w;
//            w = portraitWidth;
//        }
